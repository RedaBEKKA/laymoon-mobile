          ...
          <ScrollView bounces={false} height={screen.height / 1.8}>
              ...
              <Box flex={6}>
                <Pressable
                  ...
                  <Text color="gray.500" lineHeight="12" fontSize="12" pl={2}>
                    Gérez vos paiement sur internet, par internet par téléphone
                    et courrier
                  </Text>
                </Pressable>
              </Box>
            ...
            <Box
              ...
              <VStack space={4} alignItems="center">
                <Text
                  ...
                  fontSize="12"
                  lineHeight="12">
                  Activez ou désactivez les paiement Internet, par téléphone et
            ...
            <Box
              ...
              <Text
                ...
                fontSize="12"
                lineHeight="12">
                Attention : tous vos paiement automatiques (abonnements,vidéos à
                la demande etc.) seront suspendus jusqu’à réactivation.
              </Text>
            </Box>
          </ScrollView>
        </Box>
